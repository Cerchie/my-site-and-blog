...
![Three slides. The first shows a square. The second shows a triangle on top of the square. The third shows a rectangle added to represent a door. There are mini version of each shape under each step.](/images/house.png)
...
![Three stacked blocks representing steps, only one with SDK mentioned](/images/map1.png)
...
![Two stacked blocks representing steps, one with SDK mentioned](/images/map2.png)
